...
def train_ddp(args):
    ...
    best_ckpt_path= "18_30_best_val_checkpoint.pt"
    ...
    for epoch in range(epochs):
        ...
        if local_rank==0:
            ...
            visualize_one_sample(ddp_model.module, sample_val, device, idx=epoch,
                                 prefix="val_sample", save_dir="18_30_train_visualization_val")
    ...
    if local_rank==0:
        ...
        visualize_test_samples(ddp_model.module, test_dataset, device,
                               num_samples=5, prefix="test_sample", save_dir="18_30_test_visualization")
