...
def visualize_one_sample(model, sample, device, idx=0,
                         prefix="test_sample", save_dir="1_2_visualization_test_ddp"):
...
def train_ddp(args):
    ...
    best_ckpt_path = "1_2_modify_best_val_checkpoint.pt"
    ...
    for epoch in range(epochs):
        ...
        if local_rank == 0:
            ...
            visualize_one_sample(ddp_model.module, sample_val, device, idx=epoch,
                                 prefix="val_sample", save_dir="1_2_modify_train_visualization_val")
        ...
        with torch.no_grad():
            ...
            for i in range(min(5, len(test_dataset))):
                ...
                visualize_one_sample(ddp_model.module, sample, device, idx=i,
                                    prefix="test_sample", save_dir="1_2_modify_test_visualization")
